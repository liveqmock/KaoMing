...
public class ReportException extends Exception{
 ...
 //  private String  errorCode; //错误号
    ...
    * @param msgStr 异常信息
    */
   public ReportException(String msgStr) {
       super(msgStr);
       this.msgStr = msgStr;
   }
    ...
    */
   public ReportException (String errorCode,String msgStr){
       super(msgStr);
  ...
  /** 构造函数<br>
    ...
    * @see XMLMessages.java
    */
   public ReportException(String msgStr, Throwable cause) {
        super(msgStr);
        this.msgStr = msgStr;
        this.cause = cause;
   }
    ...
    */
   public ReportException(ComMessage message){
    ...
    */
   public ReportException(ComMessage message,Throwable cause) {
        this.message = message;
        this.cause = cause;
   }
