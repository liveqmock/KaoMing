...
public class RepairSearchForm extends CommForm{
...
//	private Double invoiceFee;                //发票金额
	private String warrantyCardNo;            //保固书编号
	private Date purchaseDate;                //验收日期
	...
	private String crReason;                  //激光检测报告(old 再送修原因)
	private Long lastRepairNo;                //上次维修号
	private Date customerVisitDate;          	//客户要求到达日期
//	private Date customerRepairDate;          //客户要求修复日期
	...
	private String tempActualOnsiteDate;
	private String tempActualRepairedDate;
	...
	private String repairManStr;			  //维修员
...
//	private String parameterModify;			//参数修改
	...
	public void setRepairManStr(String repairManStr) {
		this.repairManStr = repairManStr;
	}
	...
	public String getTempActualOnsiteDate() {
		return tempActualOnsiteDate;
	}

	public void setTempActualOnsiteDate(String tempActualOnsiteDate) {
		this.tempActualOnsiteDate = tempActualOnsiteDate;
	}

	public String getTempActualRepairedDate() {
		return tempActualRepairedDate;
	}

	public void setTempActualRepairedDate(String tempActualRepairedDate) {
		this.tempActualRepairedDate = tempActualRepairedDate;
	}
	...
	public void setIrisIds(String irisIds) {
		this.irisIds = irisIds;
	}
