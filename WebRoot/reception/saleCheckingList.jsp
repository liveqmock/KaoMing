...
<table align=center width="99%">
                ...
                <tr class="tableback2"> 
				  ...
				  <td  ><html:select styleClass="form" property="saleStatus"  >
		                		<html:option value="check" >核算中</html:option>
		                		<html:option value="bf_review" >核算后</html:option>
		                	</html:select></td>
...
<script language="JavaScript">
	...
	function view(id,status){
		if(status == 'B'){
			...
			document.forms[0].action="saleInfoAction.do?method=inquiryDetail&flag=check";
