...
<table align=center width="99%">
                ...
                <tr class="tableback2"> 
                  ...
                  <td  >状态：</td>
				  <td  ><html:select styleClass="form" property="saleStatus"  >	
		                		<html:option value="review" >复核中</html:option>
		                		<html:option value="Z" >已复核</html:option>
		      						</html:select></td>
	...
	<h3 class="underline"><p align="left">&nbsp;&nbsp;<input type="submit" value="查 询"></p></h3>
	 ...
	 <%
      ...
      <tr class="<%=strTr%>"> 
          ...
          <td ><%=temp[16].equals("0.00")?"":temp[16]%></td>
...
<script language="JavaScript">
	...
	function view(id,status){
		if(status == 'B'){
			...
			document.forms[0].action="saleInfoAction.do?method=inquiryDetail&flag=review";
