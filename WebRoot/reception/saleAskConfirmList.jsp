...
%>
<body onload='setTitle("询价回复")'>
<html:form action="saleInfoAction.do?method=saleAskConfirmList" method="post" >
...
<script language="JavaScript">
	...
	function view(id){
			...
			document.forms[0].action="saleInfoAction.do?method=inquiryDetail&flag=list";
