...
<html:form action="stockFlowAction.do?method=stockInFlowList" method="post" >
<input name="flowType" type="hidden" value="I">
                  ...
                  <td width="172">
                  	<html:select  styleClass="form" property="flowItem"    style="width:100">
                  		...
                  		<%for(int i=0; flowItemList!=null&&i<flowItemList.size(); i++ ){
                            	...
                            	if(!temp[0].equals("S")&&!temp[0].equals("Z")){
                        %>
...
function f_query(){
	...
	document.forms[0].action="stockFlowAction.do?method=stockInFlowList"; 
