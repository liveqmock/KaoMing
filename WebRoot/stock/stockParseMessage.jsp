...
<table width="100%" height="100%" border="0"  cellpadding="10" cellspacing="10" bgcolor="#B6C4E3">
  <tr >
    <td align="center" bgcolor="#FFFFFF" >
      ...
      %>
        <tr> 
          <p><strong>Excel文件中的非法数据</strong></p>
        </tr>
         <%if(dataErr[0]!=null){%>
				<tr> 
          <p>零件数量非法数据所在行:</p>
        ...
        <%if(dataNull[0]!=null){%>
        <tr> 
          <p>零件名称:<%out.println(dataNull[0]);%></p>
        </tr>
        <%}%>
         <%if(dataNull[1]!=null){%>
        <tr> <td style="word-break:break-all">
          <p>简称:<%out.println(dataNull[1]);%></p>
        </td></tr>
        <%}%>
        
         <%if(dataNull[3]!=null){%>
        <tr> <td style="word-break:break-all">
          <p>料号:<%out.println(dataNull[3]);%></p>
        </td></tr>
        <%}%>
        
         <%if(dataNull[5]!=null){%>
        <tr> <td style="word-break:break-all">
          <p>零件数量:<%out.println(dataNull[5]);%></p>
       </td> </tr>
        <%}%>
        
         <%if(dataNull[6]!=null){%>
        <tr> <td style="word-break:break-all">
          <p>零件属性:<%out.println(dataNull[6]);%></p>
       </td> </tr>
        <%}%>
        <%}%>
        <tr> 
