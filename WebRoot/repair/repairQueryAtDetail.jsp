...
try{
	...
	String atTrain = rsf.getAtTrain() == null?"":rsf.getAtTrain() ;
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content12">
          ...
          <tr> 
            <td valign="top"> <table width="100%" border="0" cellpadding="1" cellspacing="1" class="content12">
                ...
                <tr class="tableback1"> 
                  <td  width="11%">PLC：</td>
                  <td  width="22%"><bean:write property="atPlc" name="repairServiceForm" /></td>
                  <td  width="11%">机械缺失配件：</td>
                  <td width="22%"><bean:write property="atMissParts" name="repairServiceForm" /></td>
                  <td width="11%">电路：</td>
                  <td ><bean:write property="atCircuit" name="repairServiceForm" /></td>
                </tr>
                <tr class="tableback1"> 
                  <td >耗用工时(天)：</td>
                  <td><bean:write property="actualDuration" name="repairServiceForm" /></td>
                  <td >其他：</td>
                  <td colspan="3"><bean:write property="atOthers" name="repairServiceForm" /></td>
                ...
                <tr class="tableback2"> 
                  ...
                  <td colspan="5"><bean:write property="atPrecision" name="repairServiceForm" /></td>
                </tr>
                <tr class="tableback2">
                  <td >头的精度：</td>
                  <td colspan="2">0&deg;位&nbsp;&nbsp;&nbsp;上母线</td>
                  <td><bean:write property="atUHW0"  name="repairServiceForm"  /></td>
                  <td >0&deg;位&nbsp;&nbsp;&nbsp;侧母线</td>
                  <td><bean:write property="atSHW0"  name="repairServiceForm"  /></td>
                </tr>
				<tr class="tableback2">
                  <td ></td>
                  <td colspan="2">90&deg;位&nbsp;&nbsp;&nbsp;上母线</td>
                  <td><bean:write property="atUHW90"  name="repairServiceForm"  /></td>
                  <td >90&deg;位&nbsp;&nbsp;&nbsp;侧母线</td>
                  <td><bean:write property="atSHW90"  name="repairServiceForm"  /></td>
                </tr>
                <tr class="tableback2">
                  <td ></td>
                  <td colspan="2">180&deg;位&nbsp;&nbsp;&nbsp;上母线</td>
                  <td><bean:write property="atUHW180"  name="repairServiceForm"  /></td>
                  <td >180&deg;位&nbsp;&nbsp;&nbsp;侧母线</td>
                  <td><bean:write property="atSHW180"  name="repairServiceForm"  /></td>
                </tr>
                <tr class="tableback2">
                  <td ></td>
                  <td colspan="2">270&deg;位&nbsp;&nbsp;&nbsp;上母线</td>
                  <td><bean:write property="atUHW270"  name="repairServiceForm"  /></td>
                  <td >270&deg;位&nbsp;&nbsp;&nbsp;侧母线</td>
                  <td><bean:write property="atSHW270"  name="repairServiceForm"  /></td>
                </tr>
				...
				<tr class="tableback1">
                	<td>培训：</td>
                    <td colspan="5">
                    	<input type="checkbox" name="chk" value="A" <%if(atTrain.indexOf("A")!=-1){ %>checked <%} %>>机床结构&nbsp;
                    	<input type="checkbox" name="chk" value="B" <%if(atTrain.indexOf("B")!=-1){ %>checked <%} %>>使用操作（刀库、头库、机床）&nbsp;
                    	<input type="checkbox" name="chk" value="C" <%if(atTrain.indexOf("C")!=-1){ %>checked <%} %>>保养要点&nbsp;
                    	<input type="checkbox" name="chk" value="D" <%if(atTrain.indexOf("D")!=-1){ %>checked <%} %>>基本故障处理&nbsp;
                    	<input type="checkbox" name="chk" value="E" <%if(atTrain.indexOf("E")!=-1){ %>checked <%} %>>机床配件操作讲解
                    	<input type="checkbox" name="chk" value="F" <%if(atTrain.indexOf("F")!=-1){ %>checked <%} %>>特殊配件培训
                    </td>
                ...
                <tr class="tableback2">
                	<td>验收单：</td>
                    <td colspan="5">
                    	<html:radio property="atSign" value="A" />签订&nbsp;
                    	<html:radio property="atSign" value="B" />未签说明：&nbsp;<bean:write property="atUnsignRemark"  name="repairServiceForm"  />
                    </td>
                </tr>
	...
	<div align="center"  style="position:absolute; left:35;  width:912px;  z-index:1; "> 
		<table border="0" width="100%" cellpadding="0" cellspacing="0" class="content12">
		  <tr> 
			  ...
			  <td align="right"> 
				<input name="repeatedReceivePrintButton" type="button" class="button6" onClick="dispatchPrint('<%=rsf.getRepairNo().toString()%>')" value="派工单打印">
				<input name="repeatedReceivePrintButton" type="button" class="button6" onClick="repairReportPrint('<%=rsf.getRepairNo().toString()%>')" value="维修报告打印">
