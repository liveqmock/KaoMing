...
<html:html>
<head>
<title>jcCompleteList.jsp</title>
...
function view(id,status){
	middleOpen("repairTurningAction.do?method=jcCompleteDetail&repairNo="+id+"&status="+status,"","scrollbars=yes,width=1000,height=700,status=yes");    
}
...
<%
 try{	
    ArrayList jcCompleteList = (ArrayList)request.getAttribute("jcCompleteList");
    
    int count=jcCompleteList == null?0:Integer.parseInt((String)jcCompleteList.get(0));
%>
<body bgcolor="#ffffff" leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0" >
<html:form action="repairTurningAction.do?method=jcCompleteList" method="post">
                ...
                <tr> 
                  <td valign="top">
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td class="content12"><strong>检测報告查询</strong></td>
                      </tr>
                    </table>
                    <br>
                    ...
                    <table  width="1100" border="0" cellpadding="0" cellspacing="1" class="content12" id="tableid">
                      ...
                      <tbody>
<%
	if(jcCompleteList!=null){
   	    String strTr="";
  	    for(int i=1;i<jcCompleteList.size();i++){
  	        if(i%2==0) strTr="tableback2";
  	        else strTr="tableback1";
  			String[] temp=(String[])jcCompleteList.get(i);
  %>
	<tr class="<%=strTr%>" > 
