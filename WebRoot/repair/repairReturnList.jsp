...
function view(id,status){
	middleOpen("repairAction.do?method=repairReturnDetail&repairNo="+id+"&status="+status,"","scrollbars=yes,width=1000,height=700,status=yes");    
}
...
<html:form action="repairAction.do?method=repairReturnList" method="post">
