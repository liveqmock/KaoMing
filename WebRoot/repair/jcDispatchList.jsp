...
<html:html>
<head>
<title>jcDispatchList.jsp</title>
...
function view(id,status){
	middleOpen("repairTurningAction.do?method=jcDispatchDetail&repairNo="+id+"&status="+status,"","scrollbars=yes,width=1000,height=700,status=yes");    
}
...
<%
 try{	
    ArrayList jcDispatchList = (ArrayList)request.getAttribute("jcDispatchList");
    
    int count=jcDispatchList == null?0:Integer.parseInt((String)jcDispatchList.get(0));
%>
<body bgcolor="#ffffff" leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0" >
<html:form action="repairTurningAction.do?method=jcDispatchList" method="post">
                ...
                <tr> 
                  <td valign="top">
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td class="content12"><strong>检测派工查询</strong></td>
                      </tr>
                    </table>
                    <br>
                    ...
                    <table  width="1100" border="0" cellpadding="0" cellspacing="1" class="content12" id="tableid">
                      ...
                      <tbody>
<%
	if(jcDispatchList!=null){
   	    String strTr="";
  	    for(int i=1;i<jcDispatchList.size();i++){
  	        if(i%2==0) strTr="tableback2";
  	        else strTr="tableback1";
  			String[] temp=(String[])jcDispatchList.get(i);
  %>
    ...
    <td onmouseover="this.style.color='orange'" onmouseout="this.style.color='black'" style="cursor: hand" align=center onclick="javascript:view('<%=temp[0]%>','<%=temp[12]%>')"><%=temp[1]%></td>
      ...
      <td ><font <%if("Y".equals(temp[20])){ %> color="red" <%} %>><%=temp[19]==null?"":temp[19]%></font></td>
