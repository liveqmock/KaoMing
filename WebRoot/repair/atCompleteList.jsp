...
<html:html>
<head>
<title>atCompleteList.jsp</title>
...
function view(id,status){
	middleOpen("repairTurningAction.do?method=atCompleteDetail&repairNo="+id+"&status="+status,"","scrollbars=yes,width=1000,height=700,status=yes");    
}
...
<%
 try{	
    ArrayList atCompleteList = (ArrayList)request.getAttribute("atCompleteList");
    
    int count=atCompleteList == null?0:Integer.parseInt((String)atCompleteList.get(0));
%>
<body bgcolor="#ffffff" leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0" >
<html:form action="repairTurningAction.do?method=atCompleteList" method="post">
                ...
                <tr> 
                  <td valign="top">
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td class="content12"><strong>安调報告查询</strong></td>
                      </tr>
                    </table>
                    <br>
                    ...
                    <table  width="1100" border="0" cellpadding="0" cellspacing="1" class="content12" id="tableid">
                      ...
                      <tbody>
<%
	if(atCompleteList!=null){
   	    String strTr="";
  	    for(int i=1;i<atCompleteList.size();i++){
