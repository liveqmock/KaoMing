...
function showIrisDialog(content,desc,name){
	window.showModalDialog("repairAction.do?method=irisContent&flag=view&irisContent="+(content)+"&desc="+desc+"&name="+name+"&Rnd="+Math.random(),"","dialogHeight: 180px; dialogWidth: 500px; edge: Sunken; center: Yes; help: No; resizable: No; status: Yes;");
					...
					<tr>
						<td width="100%">
				         ...
				         <tr class="tableback2"> 
				          ...
				          <td width="10%">保修类型：</td>
				          <td width="20%">
				           <% if(!"T".equals(rsf.getRepairProperites())){%>
						      <%=DicInit.getSystemName("WARRANTY_TYPE",rsf.getWarrantyType())%>
						      <%}else{ %>
						      <%=DicInit.getSystemName("TUNING_TYPE",rsf.getWarrantyType())%>
						      <%} %>
				          </td>
          ...
          <tr> 
            <td valign="top"> <table width="100%" border="0" cellpadding="1" cellspacing="1" class="content12">
	            ...
	            <tr class="tableback1"> 
                  ...
                  <td colspan="3"><bean:write property="repairContent"  name="repairSearchForm" /></td>
                </tr>
                
               <tr class="tableback2">
                	<td>实际上门日期：<font color='red'>*</font></td>
                	<td><bean:write property="actualOnsiteDate"  name="repairSearchForm" /></td>
                    <td>实际修复日期：<font color='red'>*</font></td>
                    <td><bean:write property="actualRepairedDate"  name="repairSearchForm" /></td>
                </tr>
                
                <tr class="tableback1"> 
                  <td valign="top">遗留问题：</td>
                  <td colspan="3"><bean:write name="repairSearchForm" property="leaveProblem"  /></td>
                </tr>
                <tr class="tableback2"> 
	...
	<div align="center"  style="position:absolute; left:35;  width:912px;  z-index:1; "> 
		<table border="0" width="100%" cellpadding="0" cellspacing="0" class="content12">
		  <tr> 
			  ...
			  <td align="right"> 
			    <input name="repeatedReceivePrintButton" type="button" class="button6" onClick="repeatedReceivePrint('<%=rsf.getRepairNo().toString()%>')" value="电诊单打印">
