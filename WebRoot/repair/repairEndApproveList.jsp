...
function view(id,status){
	middleOpen("repairAction.do?method=repairCompleteCDetail&flag=approve&repairNo="+id,"","scrollbars=yes,width=1000,height=700,status=yes");    
}
...
<html:form action="repairAction.do?method=repairEndApproveList" method="post">
