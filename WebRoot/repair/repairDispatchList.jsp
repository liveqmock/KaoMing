...
function view(id,status){
	middleOpen("repairAction.do?method=repairDispatchDetail&repairNo="+id+"&status="+status,"","scrollbars=yes,width=1000,height=700,status=yes");    
}
...
<html:form action="repairAction.do?method=repairDispatchList" method="post">
