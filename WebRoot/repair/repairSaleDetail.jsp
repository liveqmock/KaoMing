...
function f_save(){
	...
	if(changeFlag==0){
		...
		document.forms[0].action="repairHandleAction.do?method=saveRepair&flag=saleSave&repairNo="+document.forms[0].repairNo.value+"&version="+document.forms[0].version.value;
...
<html:form action="repairHandleAction.do?method=repairCDetailSave" method="post">
					...
					<tr>
						<td width="100%">
						 ...
						 <tr class="tableback2"> 
				          ...
				          <td>保固书编号：</td>
				          <td><%=rsf.getWarrantyCardNo()==null?"":rsf.getWarrantyCardNo()%></td>
				          <td>生产厂商：</td>
          ...
          <tr> 
            <td valign="top"> <table width="100%" border="0" cellpadding="1" cellspacing="1" class="content12">
                ...
                <tr class="tableback1"> 
                  ...
                  <td width="20%"><html:text property="dzLinkman"  styleClass="form" size="16" maxlength="30" onchange="f_change()"/></td>
                  <td width="10%">电诊电话：</td>
                  <td width="20%"><html:text property="dzPhone"  styleClass="form" size="16" maxlength="30" onchange="f_change()"/></td>
                  <td width="10%"></td>
                  <td width="20%"></td>
                </tr>
                <tr class="tableback2"> 
                  <td width="10%">预计工期：</td>
                  <td width="20%"><html:text property="expectedDuration"  styleClass="form" size="16" maxlength="3" onkeydown="javascript:f_onlynumber();" onchange="f_change()"/></td>
                  <td width="10%">电诊备注：</td>
                  <td colspan=3><html:text property="dzRemark"  styleClass="form" size="80" maxlength="500" onchange="f_change()"/></td>
                  
                </tr>
                <tr class="tableback1"> 
                  <td valign="top">电诊原因：<font color="red">*</font></td>
                  <td colspan="5"><html:textarea property="dzReason" rows="2" cols="8" styleClass="form" style="width:90%" onchange="f_change()"></html:textarea></td>
                </tr>
                <tr class="tableback2"> 
                  <td valign="top">电诊结果：<font color="red">*</font></td>
                  <td colspan="5"><html:textarea property="dzResult" rows="2" cols="8" styleClass="form" style="width:90%" onchange="f_change()"></html:textarea></td>
                </tr>
     ...
     <tr> 
      <td valign="top"> <table width="100%" border="0" cellpadding="1" cellspacing="1" class="content12">
        <tr class="tableback2"> 
         ...
         <td width="262"><%=rsf.getRepairmanNum()%></td>
         <td width="100">工时(单)：<font color="red">*</font></td>
         <td ><%=rsf.getWorkingHours()%></td>
        </tr>
        <tr class="tableback1"> 
         <td>车船票：<font color="red">*</font></td>
         <td><%=rsf.getTicketsAllCosts()%></td>
         <td>人工费：<font color="red">*</font></td>
         <td><%=rsf.getLaborCosts()%></td>
        </tr>
