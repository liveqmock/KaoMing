...
function view(id,status){
	middleOpen("repairAction.do?method=repairDetail&repairNo="+id+"&status="+status,"","scrollbars=yes,width=1000,height=700,status=yes");    
}
...
<html:form action="repairAction.do?method=repairList" method="post">
                  ...
                  <td valign="top">
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table width="750" border="0" cellpadding="0" cellspacing="1" class="content12">
                      ...
                      <tr> 
                        <td colspan="6"><html:button property="query" value=" 查 询 " styleClass="button2" onclick="doSubmit()"/></td>
                      </tr>
                    </table>
                    <br> 
