...
function dispatch(){
	...
	ajaxChk.method = "GET";
	ajaxChk.onCompletion = atDispatch;
	ajaxChk.runAJAX();
}
...
function atDispatch(){
	...
	if(result=="part"){
		...
		if(confirm("确定派工吗？")){
			...
			document.forms[0].action="repairTurningAction.do?method=dispatch";
...
<html:form action="repairTurningAction.do?method=atDispatchDetail" method="post">
...
<table width="90%" height="96%" border="0" align="center" cellpadding="0" cellspacing="6" class="content12">
  <tr> 
     ...
     <tr> 
      <td valign="bottom"><table border="0" cellpadding="0" cellspacing="0">
		<tr> 
			...
			<td width="30"><input name="labelButton" type="button" class="button_g" onClick="MM_showHideLayers('Layer1','','hide','Layer2','','hide','Layer9','','hide','Layer10','','hide','Layer11','','show','Layer8','','hide')" onMouseOver="highlightButton('button_b')" onMouseOut="highlightButton('button_g')" value="安调派工"></td>
        </tr>
       </table></td>
     </tr>
     <tr> 
   ...
   <div align="center" id="Layer10" style="position:absolute; left:35; top:80; width:912px; height:390px; z-index:1; visibility: hidden;"> 
    ...
    <div align="center" id="Layer1" style="position:absolute; left:35; top:80; width:912px; height:390px; z-index:1; visibility: hidden;"> 
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content12">
          <tr> 
            <td valign="bottom"> <table border="0" cellpadding="0" cellspacing="0">
                <tr> 
          ...
          <tr> 
            <td valign="top"> <table width="100%" border="0" cellpadding="1" cellspacing="1" class="content12">
                ...
                <tr class="tableback1"> 
                  <td width="10%">安调联系人：</td>
                  <td width="20%"><html:text property="dzLinkman" name="repairServiceForm" styleClass="form" size="16" maxlength="10" /></td>
                  <td width="10%">安调电话：</td>
                  <td width="20%"><html:text property="dzPhone"  name="repairServiceForm" styleClass="form" size="16" maxlength="10"/></td>
                  <td width="10%"></td>
                  <td width="20%"></td>
                </tr>
                <tr class="tableback2"> 
                  <td width="10%">预计工期：</td> 
                  <td width="20%"><html:text property="expectedDuration"   name="repairServiceForm" styleClass="form" size="16" maxlength="3"  onkeydown="javascript:f_onlynumber();"/></td>
                  <td width="10%">安调备注：</td>
                  <td colspan=3><html:text property="dzRemark"  name="repairServiceForm" styleClass="form" size="80" maxlength="500"/></td>
                  
                </tr>
                <!-- <tr class="tableback1"> 
                  <td valign="top">电诊原因：<font color="red">*</font></td>
                  <td colspan="5"><html:text property="dzReason"  name="repairServiceForm"/></td>
                </tr>
                <tr class="tableback2"> 
                  <td valign="top">电诊结果：<font color="red">*</font></td>
                  <td colspan="5"><html:text property="dzResult" name="repairServiceForm"/></td>
                </tr> -->
...
%>        
   ...
   <div align="center" id="Layer11" style="position:absolute; left:35; top:80; width:912px; height:390px; z-index:1; "> 
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="content12">
     <tr> 
      <td valign="bottom"><table border="0" cellpadding="0" cellspacing="0">
        <tr> 
         ...
         <!-- <td width="30"><input name="labelButton" type="button" class="button_g" onClick="MM_showHideLayers('Layer1','','hide','Layer2','','show','Layer9','','hide','Layer10','','hide','Layer11','','hide','Layer8','','hide')" onMouseOver="highlightButton('button_b')" onMouseOut="highlightButton('button_g')" value="维修零件信息"></td> -->
         <td width="30"><input name="labelButton" type="button" class="button_g" onClick="MM_showHideLayers('Layer1','','hide','Layer2','','hide','Layer9','','hide','Layer10','','hide','Layer11','','hide','Layer8','','show')" onMouseOver="highlightButton('button_b')" onMouseOut="highlightButton('button_g')" value="携带工具"></td>
         <td width="30"><input name="labelButton" type="button" class="button_b" value="安调派工"></td>
	...
	<div align="center"  style="position:absolute; left:35;  width:912px;  z-index:1; "> 
		<table border="0" width="100%" cellpadding="0" cellspacing="0" class="content12">
		  <tr> 
			  ...
			  <td align="right"> 
			    <input name="endRepairButton" type="button" onClick="dispatch()" class="button4" value="安调派工">
