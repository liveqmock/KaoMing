...
<html:html>
<head>
<title>atDispatchList.jsp</title>
...
function view(id,status){
	middleOpen("repairTurningAction.do?method=atDispatchDetail&repairNo="+id+"&status="+status,"","scrollbars=yes,width=1000,height=700,status=yes");    
}
...
<html:form action="repairTurningAction.do?method=atDispatchList" method="post">
                ...
                <tr> 
                  <td valign="top">
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td class="content12"><strong>安调派工查询</strong></td>
                      </tr>
                    </table>
                    <br>
