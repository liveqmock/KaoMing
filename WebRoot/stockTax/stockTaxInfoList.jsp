...
<%
	try{
		...
		if(stockInfoList!=null){
			...
			allCost=Float.parseFloat((String)stockInfoList.get(1));
		}
...
<table align=center width="99%">
                ...
                <td width="97">零件数量：</td>
                  ...
                  <td width="98"> 单价：</td>
                  <td width="126"><html:text  styleClass="form" property="strPerCost" maxlength="8" size="16" onkeydown="f_onlymoney()"/></td>
                  <td width="98">库存状态：</td>
                  <td width="121">
	...
	&nbsp;&nbsp;</p></h3>
	 ...
	 <table width="99%" border="0" cellpadding="0" cellspacing="1" class="content12">
	  <tr><font color="blue">记录条数： <%=count%> &nbsp;&nbsp;&nbsp;&nbsp; 合计成本：<%=allCost %>  </font> </tr>
	 <tr>
	 <%if(reportFileName!=null){%>&nbsp;&nbsp;<a href="<%=reportFileName%>" target="_blank"><%=reportFileName.substring(reportFileName.lastIndexOf('/')+1)%></a><%}%>
       ...
       if(stockInfoList!=null){
       	    String strTr="";
      	    for(int i=2;i<stockInfoList.size();i++){
...
function f_query(){
	...
	document.forms[0].action="stockInfoListAction.do?method=stockTaxInfoList"; 
	document.forms[0].submit();
}

function view(stuffNo){
    window.open("stockInfoListAction.do?method=stockInfoView&flag=tax&stuffNo="+stuffNo,"","width=750,height=400,left=50,top=10,menubar=no,toolbar=no,resizable=yes,scrolling=yes,scrollbars=yes");
