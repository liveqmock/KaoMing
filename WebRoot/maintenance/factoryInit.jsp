...
%>
<body>
<html:form action="factoryInfoAction.do?method=factoryInit" method="post" >
<br>
...
<table width="99%" border="0" align="center" cellpadding="2" cellspacing="1" class="content12">
  ...
  <tr> 
   ...
   <tr class="tableback2">
    ...
    <td colspan="2" ><html:text  styleClass="form" property="factoryId"  maxlength="4"  size="20" 
    ...
    <td ><html:text  styleClass="form" property="factoryName"  maxlength="32"  size="16" /> </td>
...
function f_save(){
	if(checkIsNull()){
		document.forms[0].action="factoryInfoAction.do?method=insertFactory"; 
...
function checkIsNull() {
	...
	if(f_isNull(document.forms[0].factoryId,'厂商ID')&&f_isNull(document.forms[0].factoryName,'厂商名称')
    	...
    	if(document.forms[0].factoryId.value.length<3){
    		alert("厂商ID长度必须3位");
    		return false;
    	}else{
    		return true;
