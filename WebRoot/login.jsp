...
%>
<body background="imgage_km/bg2.gif" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="init()">
  ...
  <tr> 
    <td><div align="center">
        <table border="0" cellpadding="0" cellspacing="0" class="content12"> 
          <tr> 
            <td height="349"  background="imgage_km/login_pic.jpg" ><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="content12">
                <tr>
          ...
          <tr>
		    <td height="20" ><div align="center"><span class="content12"><font color="#FFFFFF">Copyright &copy;2013 上海晨冉机电有限公司  沪ICP备12016544号</font></span></div></td>
		  </tr>
        </table>
        <br>
        <br>
